...
#region 2. Get List of User Profiles - Obtains $Profiles as the reference List ($Profiles.Name)
    Try {
        Write-Color -Text "2. Obtaining lit of User profiles from ", $ProfilesPath.ToUpper(), " - " -Color White, Cyan, White
...
Write-Color "|- Total Extensions:", $Profiles.Count -Color White, Cyan -EndLine $true
...
ForEach ($Profile in $Profiles) {
    ...
    Write-Color -Text "|-- Total files found:          ", $ProfileTotalTempFiles -Color White, Magenta -EndLine $True
    Write-Color -Text "|-- Total files removed:        ", $FilesRemoved -Color White, Magenta -EndLine $True
    Write-Color -Text "|-- Total files not removed:    ", $FilesNotRemoved -Color White, Magenta -EndLine $True
    Write-Color -Text "|-- Total inaccessible Files:   ", $InaccessibleFiles -Color White, Magenta -EndLine $True
    Write-Color -Text "|-- Total space saved (MB):     ", ([Math]::Round(($SpaceSaved / 1024 / 1024),2)) -Color White, Magenta -EndLine $True
    Write-Color -Text "|-- Total space not saved (MB): ", ([Math]::Round(($SpaceNotSaved / 1024 / 1024),2)) -Color White, Magenta -EndLine $True
    $ProfilesCount ++
    #endregion
}
    #endregion
