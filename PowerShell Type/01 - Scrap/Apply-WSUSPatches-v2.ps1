...
$WSUSContentSharePath = "D:\WSUS\WsusContent"
$VHDFile = "\\nrapcfls102\managementlibrary\Virtual Hard Disks\Windows Server 2012 R2\Windows Server 2012 R2 Standard Core Gen 2.vhdx"
$TemporaryDirectory = "D:\Patching\Temp1"
$ScratchDirectory = "D:\Patching\Temp2"
Clear-Host
Write-Host
Write-Host
Write-Host
