...
$ResetEC2DNS = {
    ...
    $OutputFolder = 'C:\Temp\Henri\DNSUpdates\EC2'
...
$SBArgs = @($Credential)
Start-Jobs -ScriptBlock $ResetEC2DNS -ScriptBlockArguments $SBArgs -Targets $Servers -PassTargetToScriptBlock Both -MaximumJobs 10
