Param (
    ...
    [String] $SystemName = 'POSVCPRD01', `
    [Parameter(Mandatory=$False, Position=2)]
    [String] $IPAddress = '10.10.240.21', `
    [Parameter(Mandatory=$False, Position=3)]
    [String] $CommonName = 'POSVCPRD01 5.5', `
...
Function Send-Report {
    ...
    Send-MailMessage -From $Config.Settings.EmailSetup.From -BodyAsHtml -Body $Body -SmtpServer $Config.Settings.EmailSetup.SMTPServer -Subject $Subject -To $To -Port $SMTPPort -Attachments $File #-Credential $MailCredential
