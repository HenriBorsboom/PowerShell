...
$DNSDHCPHostSettings = {
    ...
    $OutFile = ('C:\Temp\Henri\DNSDHCPHostSettings4\' + $Server + '_' + (Get-Date).ToString('yyyy-MM-dd HH_mm_ss') + '.txt')
    $CSVOutFile = ('C:\Temp\Henri\DNSDHCPHostSettings4\' + $Server + '_' + (Get-Date).ToString('yyyy-MM-dd HH_mm_ss') + '.csv')
