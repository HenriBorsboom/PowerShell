...
Try {
    ...
    Set-Registry -RegPath 'HKLM:\System\CurrentControlSet\Control\SAM' -RegName 'MinimumPasswordLengthLimits' -RegValue 0 -RegType DWORD
}
Catch {
...
Try {
    ...
    Set-Registry -RegPath 'HKLM:\SYSTEM\CurrentControlSet\Services\LanManServer\Parameters' -RegName 'SMBServerNameHardeningLevel' -RegValue '0' -RegType DWord
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\WindowsFirewall\DomainProfile' -Name 'EnableFirewall'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\WindowsFirewall\DomainProfile' -Name 'DefaultInboundAction'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\WindowsFirewall\DomainProfile' -Name 'DefaultOutboundAction'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\WindowsFirewall\DomainProfile\Logging' -Name 'LogFilePath'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\WindowsFirewall\DomainProfile\Logging' -Name 'LogFileSize'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\WindowsFirewall\DomainProfile\Logging' -Name 'LogDroppedPackets'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\WindowsFirewall\DomainProfile\Logging' -Name 'LogSuccessfulConnections'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\WindowsFirewall\PrivateProfile' -Name 'EnableFirewall'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\WindowsFirewall\PrivateProfile' -Name 'DefaultInboundAction'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\WindowsFirewall\PrivateProfile' -Name 'DefaultOutboundAction'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\WindowsFirewall\PrivateProfile' -Name 'DisableNotifications'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\WindowsFirewall\PrivateProfile\Logging' -Name 'LogFilePath'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\WindowsFirewall\PrivateProfile\Logging' -Name 'LogFileSize'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\WindowsFirewall\PrivateProfile\Logging' -Name 'LogDroppedPackets'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\WindowsFirewall\PrivateProfile\Logging' -Name 'LogSuccessfulConnections'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\WindowsFirewall\PublicProfile\Logging' -Name 'EnableFirewall'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\WindowsFirewall\PublicProfile' -Name 'DefaultInboundAction'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\WindowsFirewall\PublicProfile' -Name 'DefaultOutboundAction'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\WindowsFirewall\PublicProfile' -Name 'AllowLocalPolicyMerge'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\WindowsFirewall\PublicProfile' -Name 'AllowLocalIPsecPolicyMerge'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\WindowsFirewall\PublicProfile\Logging' -Name 'LogFilePath'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\WindowsFirewall\PublicProfile\Logging' -Name 'LogFileSize'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\WindowsFirewall\PublicProfile\Logging' -Name 'LogDroppedPackets'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\WindowsFirewall\PublicProfile\Logging' -Name 'LogSuccessfulConnections'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\LAPS' -Name 'PwdExpirationProtectionEnabled'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\LAPS' -Name 'PasswordComplexity'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\LAPS' -Name 'PasswordLength'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\LAPS' -Name 'PasswordAgeDays'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SYSTEM\CurrentControlSet\Control\Print' -Name 'RpcAuthnLevelPrivacyEnabled'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Set-Registry -RegPath 'HKLM:\SYSTEM\CurrentControlSet\Services\TCPIP6\Parameters' -RegName 'TcpMaxDataRetransmissions' -RegValue 5 -RegType DWORD
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows NT\DNSClient' -Name 'EnableNetbios'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows NT\Printers' -Name 'RedirectionguardPolicy'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows NT\Printers\RPC' -Name 'RpcProtocols'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows NT\Printers' -Name 'CopyFilesPolicy'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\Group Policy\{827D319E-6EAC-11D2-A4EA-00C04F79F83A}' -Name 'NoGPOListChanges'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\System' -Name 'AllowCustomSSPsAPs'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\W32Time\TimeProviders\NtpClient' -Name 'Enabled'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\CloudContent' -Name 'DisableConsumerAccountStateContent'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\CloudContent' -Name 'DisableCloudOptimizedContent'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\DataCollection' -Name 'DisableOneSettingsDownloads'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\DataCollection' -Name 'EnableOneSettingsAuditing'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\DataCollection' -Name 'LimitDiagnosticLogCollection'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\DataCollection' -Name 'LimitDumpCollection'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\AppInstaller' -Name 'EnableAppInstaller'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\AppInstaller' -Name 'EnableExperimentalFeatures'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\AppInstaller' -Name 'EnableHashOverride'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\AppInstaller' -Name 'EnableMSAppInstallerProtocol'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\EventLog\Setup' -Name 'MaxSize'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Set-Registry -RegPath 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\EventLog\Security' -RegName 'MaxSize' -RegValue 163384 -RegType DWord
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\Spynet' -Name 'LocalSettingOverrideSpynetReporting'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Set-Registry -RegPath 'HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\Spynet' -RegName 'SpynetReporting' -RegValue '2' -RegType DWord
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\Windows Defender Exploit Guard\ASR\Rules' -Name '26190899-1602-49e8-8b27-eb1d0a1ce869'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    # 18.10.43.6.1.2. (L1) Ensure 'Configure Attack Surface Reduction rules: Set the state for each ASR rule' is configured
    Write-Host "18.10.43.6.1.2. (L1) Ensure 'Configure Attack Surface Reduction rules: Set the state for each ASR rule' is configured"
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\Windows Defender Exploit Guard\ASR\Rules' -Name '3b576869-a4ec-4529-8536-b80a7769e899'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    # 18.10.43.6.1.2. (L1) Ensure 'Configure Attack Surface Reduction rules: Set the state for each ASR rule' is configured
    Write-Host "18.10.43.6.1.2. (L1) Ensure 'Configure Attack Surface Reduction rules: Set the state for each ASR rule' is configured"
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\Windows Defender Exploit Guard\ASR\Rules' -Name '56a863a9-875e-4185-98a7-b882c64b5ce5'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    # 18.10.43.6.1.2. (L1) Ensure 'Configure Attack Surface Reduction rules: Set the state for each ASR rule' is configured
    Write-Host "18.10.43.6.1.2. (L1) Ensure 'Configure Attack Surface Reduction rules: Set the state for each ASR rule' is configured"
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\Windows Defender Exploit Guard\ASR\Rules' -Name '5beb7efe-fd9a-4556-801d-275e5ffc04cc'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    # 18.10.43.6.1.2. (L1) Ensure 'Configure Attack Surface Reduction rules: Set the state for each ASR rule' is configured
    Write-Host "18.10.43.6.1.2. (L1) Ensure 'Configure Attack Surface Reduction rules: Set the state for each ASR rule' is configured"
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\Windows Defender Exploit Guard\ASR\Rules' -Name '75668c1f-73b5-4cf0-bb93-3ecf5cb7cc84'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    # 18.10.43.6.1.2. (L1) Ensure 'Configure Attack Surface Reduction rules: Set the state for each ASR rule' is configured
    Write-Host "18.10.43.6.1.2. (L1) Ensure 'Configure Attack Surface Reduction rules: Set the state for each ASR rule' is configured"
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\Windows Defender Exploit Guard\ASR\Rules' -Name '7674ba52-37eb-4a4f-a9a1-f0f9a1619a2c'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    # 18.10.43.6.1.2. (L1) Ensure 'Configure Attack Surface Reduction rules: Set the state for each ASR rule' is configured
    Write-Host "18.10.43.6.1.2. (L1) Ensure 'Configure Attack Surface Reduction rules: Set the state for each ASR rule' is configured"
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\Windows Defender Exploit Guard\ASR\Rules' -Name '92e97fa1-2edf-4476-bdd6-9dd0b4dddc7b'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    # 18.10.43.6.1.2. (L1) Ensure 'Configure Attack Surface Reduction rules: Set the state for each ASR rule' is configured
    Write-Host "18.10.43.6.1.2. (L1) Ensure 'Configure Attack Surface Reduction rules: Set the state for each ASR rule' is configured"
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\Windows Defender Exploit Guard\ASR\Rules' -Name '9e6c4e1f-7d60-472f-ba1a-a39ef669e4b2'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    # 18.10.43.6.1.2. (L1) Ensure 'Configure Attack Surface Reduction rules: Set the state for each ASR rule' is configured
    Write-Host "18.10.43.6.1.2. (L1) Ensure 'Configure Attack Surface Reduction rules: Set the state for each ASR rule' is configured"
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\Windows Defender Exploit Guard\ASR\Rules' -Name 'b2b3f03d-6a65-4f7b-a9c7-1c7ef74a9ba4'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    # 18.10.43.6.1.2. (L1) Ensure 'Configure Attack Surface Reduction rules: Set the state for each ASR rule' is configured
    Write-Host "18.10.43.6.1.2. (L1) Ensure 'Configure Attack Surface Reduction rules: Set the state for each ASR rule' is configured"
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\Windows Defender Exploit Guard\ASR\Rules' -Name 'be9ba2d9-53ea-4cdc-84e5-9b1eeee46550'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    # 18.10.43.6.1.2. (L1) Ensure 'Configure Attack Surface Reduction rules: Set the state for each ASR rule' is configured
    Write-Host "18.10.43.6.1.2. (L1) Ensure 'Configure Attack Surface Reduction rules: Set the state for each ASR rule' is configured"
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\Windows Defender Exploit Guard\ASR\Rules' -Name 'd3e037e1-3eb8-44c8-a917-57927947596d'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    # 18.10.43.6.1.2. (L1) Ensure 'Configure Attack Surface Reduction rules: Set the state for each ASR rule' is configured
    Write-Host "18.10.43.6.1.2. (L1) Ensure 'Configure Attack Surface Reduction rules: Set the state for each ASR rule' is configured"
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\Windows Defender Exploit Guard\ASR\Rules' -Name 'd4f940ab-401b-4efc-aadc-ad5f3c50688a'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\MpEngine' -Name 'EnableFileHashComputation'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\Reporting' -Name 'DisableGenericRePorts'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\Scan' -Name 'DisableEmailScanning'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows NT\Terminal Services' -Name 'EnableUiaRedirection'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows NT\Terminal Services' -Name 'fDisableCcm'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows NT\Terminal Services' -Name 'fDisableLocationRedir'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows NT\Terminal Services' -Name 'fDisableLPT'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows NT\Terminal Services' -Name 'fDisablePNPRedir'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows NT\Terminal Services' -Name 'fDisableWebAuthn'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\PushToInstall' -Name 'DisablePushToInstall'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\Windows Search' -Name 'EnableDynamicContentInWSB'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System' -Name 'EnableMPR'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender Security Center\App and Browser protection' -Name 'DisallowExploitProtectionOverride'
}
Catch {
    Write-Host "Not applied"
}
...
Try {
    ...
    Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate' -Name 'ManagePreviewBuildsPolicyValue'
}
Catch {
    Write-Host "Not applied"
}
