...
<#
(Get-ChildItem -LiteralPath 'C:\Temp\D0'-Directory).FullName | Out-File 'C:\Temp\D0.txt' -Encoding ascii
(Get-ChildItem -LiteralPath 'C:\Temp\D1'-Directory).FullName | Out-File 'C:\Temp\D1.txt' -Encoding ascii
(Get-ChildItem -LiteralPath 'C:\Temp\D2'-Directory).FullName | Out-File 'C:\Temp\D2.txt' -Encoding ascii
(Get-ChildItem -LiteralPath 'C:\Temp\D3'-Directory).FullName | Out-File 'C:\Temp\D3.txt' -Encoding ascii
(Get-ChildItem -LiteralPath 'C:\Temp\D4'-Directory).FullName | Out-File 'C:\Temp\D4.txt' -Encoding ascii
(Get-ChildItem -LiteralPath 'C:\Temp\D5'-Directory).FullName | Out-File 'C:\Temp\D5.txt' -Encoding ascii
(Get-ChildItem -LiteralPath 'C:\Temp\D6'-Directory).FullName | Out-File 'C:\Temp\D6.txt' -Encoding ascii
(Get-ChildItem -LiteralPath 'C:\Temp\D7'-Directory).FullName | Out-File 'C:\Temp\D7.txt' -Encoding ascii
(Get-ChildItem -LiteralPath 'C:\Temp\D8'-Directory).FullName | Out-File 'C:\Temp\D8.txt' -Encoding ascii
(Get-ChildItem -LiteralPath 'C:\Temp\D9'-Directory).FullName | Out-File 'C:\Temp\D9.txt' -Encoding ascii
#>
...
$ScriptBlock = {
    Param ($Folder)
    $ReportFile = ('C:\Temp\Reports\' + $Folder.Replace('C:\', '').Replace('\', '_') + '.txt')
...
$D0 = Get-Content 'C:\Temp\D0.txt'
$D1 = Get-Content 'C:\Temp\D1.txt'
$D2 = Get-Content 'C:\Temp\D2.txt'
$D3 = Get-Content 'C:\Temp\D3.txt'
$D4 = Get-Content 'C:\Temp\D4.txt'
$D5 = Get-Content 'C:\Temp\D5.txt'
$D6 = Get-Content 'C:\Temp\D6.txt'
$D7 = Get-Content 'C:\Temp\D7.txt'
$D8 = Get-Content 'C:\Temp\D8.txt'
$D9 = Get-Content 'C:\Temp\D9.txt'
