...
Function In-FunctionLogging{
    Write-log -Logfile $LogFile -Message "Test Message 2" -Component "In-FunctionLogging" -Level Info
}
$LogFile = 'C:\Temp\Logging.log'
Write-log -Logfile $LogFile -Message "Test Message 1" -Component "Main" -Level Info
In-FunctionLogging
Write-Log -Logfile $LogFile -Message "Test Message 13" -Component "Whatever" -Level Error
