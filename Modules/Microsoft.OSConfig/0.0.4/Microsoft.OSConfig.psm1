...
$PrivateFiles = @(Get-ChildItem -Path (Join-Path -Path $PSScriptRoot -ChildPath 'private/*.ps1') -Recurse -ErrorAction Stop)
$PublicFiles = @(Get-ChildItem -Path (Join-Path -Path $PSScriptRoot -ChildPath 'public/*.ps1')  -Recurse -ErrorAction Stop)
$TransformerFiles = @(Get-ChildItem -Path (Join-Path -Path $PSScriptRoot -ChildPath 'transformers/*.ps1') -Recurse -ErrorAction Stop)

Set-Variable -Name Constants -Value (Import-PowerShellDataFile "$PSScriptRoot/private/Constants.psd1") -Option AllScope, Constant -Force

foreach ($File in @($ClassFiles + $PrivateFiles + $PublicFiles + $TransformerFiles)) {
    try {
        . $File.FullName
    } catch {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD7sxqexSbTrvZI
# JM47QqYHdFbh+QBg1QpfFrPtfqEY5aCCDXYwggX0MIID3KADAgECAhMzAAADrzBA
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEINETprJEVuyjVTb69pSeEM3f
# GX0CkWRfmvnXOOlTbn9cMEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEB
# BQAEggEATmBVU/4ROga+lQbjwrEHYKorAQyFUHx0d74NAjIU2OVBdC4PWqheZSlB
# GqqLXmLe4PVulanIGMWrHrXsGONAtTfzc+K4WCK+ObExNCK4JNVbiKotxXVnBCXb
# LjYD+Y1AOFbOuQcdj3Sl5TU18NTQ+dBPz6p17Sv4aU0aXQOm9kuVqeK6gCHcXTam
# gXpv/sP/IWWwBbhvSp7zNoyHEp1bC6mrfnmN1ZplK7Cq1y6YfVqh58+foTCMETR7
# EpOE5eNjiSwSmdgjU2uSxNsJwOAQRZ5svln3DGPe45e5+KdAL65FPsuBaid2xPlD
# bgFTkruvWOh0MZxILh89c8eIvgHFKKGCFyowghcmBgorBgEEAYI3AwMBMYIXFjCC
# FxIGCSqGSIb3DQEHAqCCFwMwghb/AgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFZBgsq
# hkiG9w0BCRABBKCCAUgEggFEMIIBQAIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFl
# AwQCAQUABCDPm7/UL/57cFFtxq/kG6xXOPbYnLaa9t313f7W363mFwIGZdY1qYhY
# GBMyMDI0MDMxMjE5MDIwMS44MjlaMASAAgH0oIHYpIHVMIHSMQswCQYDVQQGEwJV
...
# MSIEIPItF7SzFo3cigW+oLDGDOflYVjZ1ocz+wMJCw4DQRhwMIH6BgsqhkiG9w0B
...
# CzANBgkqhkiG9w0BAQsFAASCAgCK8fqaWmKiNs0KuYXgqho9mqef8BzF0cGCnNUD
# pKbhofhb9WT20Z/9CPhPp12P+BAAyIXXIGFJ0SkSlNYElpMplTHX7rUmrI5Kf/9S
# Xh7Nag/DY0V5thHzrwGMzlO662v1z4M+X6T/5QYJfmi8ciuXXMyI4YAGlxD990b8
# zmIqVY4QU+Qtwpvql7Ag9UFp4GZAet2ybcVXkOLy7jlOqVVAJjVaOAAs/hAJPMV8
# Q0KIR8sneeD/0p+dBBoSVLHm4/vM0CB0amT4ENNjMnAzcSascwGnfsIZydHoJY6Y
# BDp3GrMynJpjA+jb3vGrKblsVolPFbVJ1FlwQPTiJLJBarZNewF220xe7rjFDcNJ
# 9LvDwNqliyxm0Gbar+ygI8nMIuoWuokWiaa9lNeScsyIPCFny7IuiR5vomSOTy8h
# sj+FSbHor7UcInBOK12onYnau6+9bpmkcAfwSTkb21ZXN6kQaSVqXa4vBEF4xfTR
# qcaGIpsZdBtdAUBMjdDyf/FK1GszYRZzsUWEHB7Fr/G46bi1zwQrfBSd/Jb2lXJX
# 76Uw6TftJQmCUwbYzviiyQR76pUmUItk3Nfm0D3vCbVbjtmW5EMjOkaWHzFbWylV
# dNHK5z5/0DBQpirBSMgkZkFwSlu8JZQnDOSIJz851TkESIwSkIqdSPg4zUwEnnXA
# EmlZkQ==
