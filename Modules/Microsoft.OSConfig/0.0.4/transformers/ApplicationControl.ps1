...
function ConvertTo-Policy {
    ...
    if (($Value -like "*.xml") -or ($Value -like "*.cip")) {
        if (-not (Test-Path -Path $Value)) {
            throw [InvalidValueException]::new("File not found: '$Value'")
        }
    }

    if ($Value -like "*.cip") {
        $CIPolicy = Get-Item -Path $Value
        $PolicyID = (Split-Path -Path $CIPolicy -Leaf).Replace(".cip", "").TrimStart("{").TrimEnd("}")
        ...
        if (-not $PolicyID) {
            throw [InvalidValueException]::new("Policy ID not found in '$Value'")
        } else {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC8eaBCZ2nGn/QP
# aXXxiw0P0oe/RfkIMXy+ZHLrFo7Hx6CCDXYwggX0MIID3KADAgECAhMzAAADrzBA
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIHr45YJU7ybvtE3TEShBRZKa
# xb/HF89T6lw2WMnEtFR+MEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEB
# BQAEggEADq5y5L1hKbyO35v7In8sk+60gIhnhUv3+05m8zgDycpugRkXYlkiOUyX
# H7AQUzH04wRqfyNF1p5yTjSaQuNHP4yMGfER707hLP7vHT3OUSd+QpcfT4kJomN5
# YQhYTZSIomjgS1ttXfvhxsUQvykexIYfBxbn2m9Zv/mJQlJNnbW7Nj66YJ9MZpzN
# pkVDGgRwVpeloa1XYxNdxSwiA2iXRly3Nn2EFVGvUDGDtIUhfm4Gn2lyFyiHTQXb
# JaqYq95x6pkExjVMaF2mJgSFmz8w8VctpUPD+BZAUR4RMmE7cNmgEG4jMuOVRLYo
# SLxFBS0OuHGbRB9gxUFSm4QjJG3IbqGCFywwghcoBgorBgEEAYI3AwMBMYIXGDCC
# FxQGCSqGSIb3DQEHAqCCFwUwghcBAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFZBgsq
# hkiG9w0BCRABBKCCAUgEggFEMIIBQAIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFl
# AwQCAQUABCAYCoB8QbL6odZq38hq0EL3NliujIRo73qJW1SbMw1ejAIGZdZEGepi
# GBMyMDI0MDMxMjE5MDE1NC44MTFaMASAAgH0oIHYpIHVMIHSMQswCQYDVQQGEwJV
...
# CQQxIgQgijQ+OczbJibEQPB7s/TtN4QEky5QRB+0XTK5oiJa0KcwgfoGCyqGSIb3
...
# lZRhMA0GCSqGSIb3DQEBCwUABIICAA6GkuqkblmVG9ZFiKmQkWtRtY1YEQx3sx3H
# H3gxIMsOpS++TnhP8wt3iKPU8jNHrTZXWXakDgfETSNNBpcQ8MDtNCJdY+vlDlGn
# a52vmaQlcyW+ZIU0Kc4Pr7YI0OQdNldWKDUBTiAay+Tp5r4Ufx6mO+I3iYsu3FyA
# YiLpQjfoIXqa8jqp6wCrVtdJUyrlz+7zd3xK0EIXSfa9g6Da1zOyXIUNH21cBzTS
# ZMf9TWTURvXKFS0kX1TyIfbDzeUTsdchlw/DataiZvN1524SCL36DJi5KqtE++nm
# e2aJ0TsZeIjcIUGbfhBln0Yg0+t1zryDE/3qrw165NM3MsthtkR7qIIj8HB4u8UM
# t/7esG1Wnwa4XA6lGa40CGPuu8joKecFfBJHByToAod/6pzX++0J79ESbE0jibMW
# qrd0X/1cCYE6alUD8JXdZZwu+BKC4pifSxslAr6RkWl+vzPO6g6UmEuFVnOG5Ewh
# 0pQ7MOpaRH8xsegr4Up5ZplHyjIwflnxSBQZJc+OQndQ2BYic+0/2irRhmB5kSkc
# yelS8W1zxIiz5fa2hD+tH/VQ1utJbda9XJAfaaaSVL2EwVremJ22szAW/94vBp1d
# FGl197v/zXnalREffTRtQ+c4DQJNa1Pr0uokI05wMLkXu8b83NYbKlw3PciVdei+
# NdL03wwC
