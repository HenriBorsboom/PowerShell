...
function Get-OSConfigScenarioDefinition {
    <#
    .SYNOPSIS
    ...
    .EXAMPLE
        Get-OSConfigScenarioDefinition -Name "MyScenario"

        Gets the metadata of the scenario.

    .EXAMPLE
        Get-OSConfigScenarioDefinition -Name "MyScenario" -Version "1.0"

        Gets the metadata of the scenario with the specified version.

    .EXAMPLE
        Get-OSConfigScenarioDefinition
    ...
    try {
        ...
        $Name, $Temp = Get-Attributes -DisplayName $Name
        ...
        $Metadata = Get-Metadata -SourceId $SourceId
        $Metadata = $Metadata | Where-Object { (-not $Name) -or ($_.Name -eq $Name) }
        $Metadata = $Metadata | Where-Object { (-not $Version) -or ($_.Version -eq $Version) }
        $Metadata = $Metadata | ForEach-Object {
            if ($_.DisplayName) {
                $_.Name = $_.DisplayName
            }
            $_
        } | Select-Object -Property * -ExcludeProperty DisplayName
        $Metadata
    } catch {
        $StopWatch.Stop()
        $ErrorRecord = $_
...
Register-ArgumentCompleter -CommandName Get-OSConfigScenarioDefinition -ParameterName Name -ScriptBlock $ScenarioCompletion
Register-ArgumentCompleter -CommandName Get-OSConfigScenarioDefinition -ParameterName Version -ScriptBlock $VersionCompletion
Register-ArgumentCompleter -CommandName Get-OSConfigScenarioDefinition -ParameterName Authority -ScriptBlock $AuthorityCompletion

# SIG # Begin signature block
# MIIoKgYJKoZIhvcNAQcCoIIoGzCCKBcCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAkEQnDJjVd4JYu
# hit0FSQz+y+fGY/svp57x6QPjwIqVKCCDXYwggX0MIID3KADAgECAhMzAAADrzBA
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIGmBeXgVvgCqzgr2UtT9aQEl
# nigbEuVtnOojM31acHG7MEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEB
# BQAEggEAHJLWjLkj1MoozrZxkXJuUp/qhSlfGYAz+xLup3u1Uh0RborbcTqyu6oe
# ADrxvCWrbCpeF/Q/JPkx7iewXUOHJKRRpIyTBUxUJowMH5wV8ephCDh6Zu2PdgFX
# WbTTG3KimIwRDuH26fE31PQbBZ01hpRFxoABUz8wgozGWfxpdjVi65kpidsAMcLF
# cBtVMwTkuCOcWiww5MWuSTaPwDlWtW4/9aSs5DZGBCTfDhu2LQj/RRSech7BiWey
# x9hLwhRCBnXE7PXGauap7+Uq6EDeN0B+GO91YLk53LuqDJlhk3w99Pk1VTf0qdR9
# yldfRRtSVwCzW40N8H8AlUfhbRATraGCF5QwgheQBgorBgEEAYI3AwMBMYIXgDCC
# F3wGCSqGSIb3DQEHAqCCF20wghdpAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFSBgsq
# hkiG9w0BCRABBKCCAUEEggE9MIIBOQIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFl
# AwQCAQUABCAO0XEgdpZr2gBQagcsxLF6ajEOJHLvQWTk7hDB2fowggIGZeeoC/ZZ
# GBMyMDI0MDMxMjE5MDE1My41NzlaMASAAgH0oIHRpIHOMIHLMQswCQYDVQQGEwJV
...
# IFBDQSAyMDEwMA0GCSqGSIb3DQEBCwUAAgUA6Zq31jAiGA8yMDI0MDMxMjExMTUz
# NFoYDzIwMjQwMzEzMTExNTM0WjB0MDoGCisGAQQBhFkKBAExLDAqMAoCBQDpmrfW
# AgEAMAcCAQACAg8DMAcCAQACAhGlMAoCBQDpnAlWAgEAMDYGCisGAQQBhFkKBAIx
# KDAmMAwGCisGAQQBhFkKAwKgCjAIAgEAAgMHoSChCjAIAgEAAgMBhqAwDQYJKoZI
# hvcNAQELBQADggEBAIodiZI6GnOSBHtpqvObbwpZIAfr8jKVotOWbBB6AdWqSSpl
# wGn/eUp6HeQqYdYDqV+c0UFCljPnA4YmhpsyDP5Ah2u0mmjvneUHi2tWYNYDwl1E
# 3NhrlcAonqcfnB0h1CLI39Le9ohw54ll1hBqTXLWDVlz9x3DeOd2Q4U0z6BJsGN+
# Bgsj9BkSlQfUIqbYWUliltMGemT92k3GiUErOwVgreobjlHRxTodI5yTMPb5y7ku
# 2ul/GyLVjBHPeih6jge3ub1b31BftQgnwRP4HqnnKYu+fo/ZsWSa8ytGcVx5zD/t
# 1eGoNYfM91uipe0ONnEOUV/18RfcviLgLzfXbqMxggQNMIIECQIBATCBkzB8MQsw
# CQYDVQQGEwJVUzETMBEGA1UECBMKV2FzaGluZ3RvbjEQMA4GA1UEBxMHUmVkbW9u
# ZDEeMBwGA1UEChMVTWljcm9zb2Z0IENvcnBvcmF0aW9uMSYwJAYDVQQDEx1NaWNy
# b3NvZnQgVGltZS1TdGFtcCBQQ0EgMjAxMAITMwAAAfGzRfUn6MAW1gABAAAB8TAN
# BglghkgBZQMEAgEFAKCCAUowGgYJKoZIhvcNAQkDMQ0GCyqGSIb3DQEJEAEEMC8G
# CSqGSIb3DQEJBDEiBCDkfGe47/JSAcS2Cn5prHbh3e9rn35QwunEbNFogQy6NDCB
...
# MTACEzMAAAHxs0X1J+jAFtYAAQAAAfEwIgQgmb8TFiS3s6Czp8o1tGj7s0kCYGBh
# 0/qsB418yvZN6NkwDQYJKoZIhvcNAQELBQAEggIASgDX0ksxAbPg1AVp+c1gN1qR
# ObSYxizBjr2Oxnm4I+NBsyLQtfce7skKIfUR7ieiHqb5bfBh0Eq0DbNa16pw1lob
# YigoTJ5gIrqyjXrXyj3fTYD4idlLZa+aCJUFlQUpw4qic0NwW0QfTLr7OPAYsaSg
# FIXXKpMx+mdlgCUsst7ltBO+aV5vySmVtcNNnGNOLIcifQfb/1yjsCSPeVpDsgCI
# PjO7KuAWJ2W4/VCICNEnerR/D0b5vdtcAdN/suQ3rYqTuuE1ZR2kWiteQZYTVvWX
# gwBqpcQ0CusJfLygLHal9cR+tXGNshoJ7fzPobqO67aXKEV4nIzpfscVhmxN44pv
# Loo7B2TyAJ9bwG/HKBhdIxOtAt+7G8//U4l2dsd1B5VOSurOAIrPzx+/hP2cr8YO
# slZquIf7JIq3qAUr5Sefr6j1QcQSWL7xFyUBC+44yfDbZFXapg6hGsJG8Bn9cu0Y
# e9fsyV6nTJAzdF/qpWtS6+a6IN3dwjSLCRZGywszfsIj1q/oiOP3Vj/ALUFn6+wN
# W36OgjCGjMrhF1cA7W4Zn8QV7Y9Pjq4BlY3NLs+KEzS9GrYqvKfxwj7BPRJb3ECn
# LIbNBd1pg/RkAKCBBd7Q4rIUxGKu4Iiy3R7EJ2FCe1hNhsOrb7GeHjrawko9F6XM
# YVGQpQoX2UKQwmcb4fk=
