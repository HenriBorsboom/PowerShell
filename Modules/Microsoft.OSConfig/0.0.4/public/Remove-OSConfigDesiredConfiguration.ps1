...
function Remove-OSConfigDesiredConfiguration {
    ...
    .EXAMPLE
        Remove-OSConfigDesiredConfiguration -Scenario "MyScenario" -Name "MySetting"
    ...
    try {
        ...
        $Scenario, $Version = Get-Attributes -DisplayName $Scenario
        Assert-Parameters -CmdletType DesiredConfiguration -Scenario $Scenario -Version $Version -Setting $Name
        ...
        if (-not ($PSCmdlet.ShouldProcess((Get-Target -Scenario $Scenario -Version $Version -Setting $Name)))) {
            return
        }

        if ($Name) {
            $Documents = Get-DocumentContent -SourceId $SourceId -Scenario $Scenario -Setting $Name -Action "Set"
            $Documents | ForEach-Object {
                $_.OsConfiguration.Scenario[0].$Scenario.PSObject.Properties.Remove($Name)

                if (@($_.OsConfiguration.Scenario[0].$Scenario.PSObject.Properties).Count -gt 0) {
            ...
            $Documents = Get-DocumentContent -SourceId $SourceId -Scenario $Scenario -Action "Set"
        ...
        Write-Telemetry -ErrorRecord $ErrorRecord -SourceId $SourceId -Parameters @{ Scenario = $Scenario; Version = $Version; Name = $Name; } -StopWatch $StopWatch | Out-Null
    }
}
...
Register-ArgumentCompleter -CommandName Remove-OSConfigDesiredConfiguration -ParameterName Name -ScriptBlock $SettingCompletion
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAn95hTzLPp3IhR
# 1Dbwg7aZ9/SLprLpdT5VKHaftOKG7qCCDXYwggX0MIID3KADAgECAhMzAAADrzBA
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEICsNfJPvOhtQE3ZXb28jpebJ
# KwvCbXpzSxKpvKASvACnMEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEB
# BQAEggEAEt+toqHULaP6t69/N9l3Kj9iHwrqDBf7hoat/B6UziZmEuxuCGPqwddL
# xWaNqjcgbIe1b6lm4JGkD5cxybNEbWecxLgyo8RkJaKASdYJWn5FEXsgorCRCsUt
# Ls7jWhcPAt4o19icqrjSYovp0wtN6jR1EVkj91zQ2/VDkBHCSROuZ8yj7Z1aYpkC
# l5K+4SifZW1if8NzJVNAFCJIeKDqw8otUpyIi/uMC9PA3rUiyxSXIxeHELaF95ft
# 8/pUpn51TL252YTACBUAhcSNCwxvpPD1/a2BkVgJy76xgGFFqOR2L28wE8ulWpe2
# K7IrYvWgvUG8G2aRLI607xTNHgk0gqGCFywwghcoBgorBgEEAYI3AwMBMYIXGDCC
# FxQGCSqGSIb3DQEHAqCCFwUwghcBAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFZBgsq
# hkiG9w0BCRABBKCCAUgEggFEMIIBQAIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFl
# AwQCAQUABCAX2tnBhdF2LS2fb7YLDa/jPqUniip8WFoohc/AsbQNGgIGZdZEGek9
# GBMyMDI0MDMxMjE5MDE1MS4wNThaMASAAgH0oIHYpIHVMIHSMQswCQYDVQQGEwJV
...
# CQQxIgQgCAisSFpS/TmTI6Cu3f3AnLYKGx6vYq/4U3EebVH7il0wgfoGCyqGSIb3
...
# lZRhMA0GCSqGSIb3DQEBCwUABIICAGON107XiKPCnqLQEMBZxkd6EyTvSjrzkJQ2
# /kplG4lOZJW5G67USGySQJNRvfgsOAnxrckr1N9OJCN09bO1ejV6pNxjOeu4eil2
# 451A7mU613Q1nB9NdVrD5FntyNUM3SwKP/sOyI9Y0+PA6ZGGksKv3wtgf3HtTmYU
# XA4lxHpZqx7iOCExBLRVmFfgIqaJFviswzF3xf28umq5e3Zx5WlV9YvCDBFXg7v2
# whfdRpmNSiNQFNhWRRAmsAsmoWniXP8+qZPTtmwKTF3nD2R9taji01F5HzvRLq0s
# H74o9sclhUVBq/MZ9x3SPVqGLIn4ATTuCUajUY/R2iahEAbo9bFl0IhHGnFOyxpO
# MmuUyeaBH7W2mnWmYKzgliWYcGmPnCqtcWJlWrTLthQUf0MZvQYOeg7MuRrG6WUl
# 15FRybXFOIGjSHNrFF11zTNIiuOKkSEF0TmyeuqgobI4KK4sCGzpKd0cN+AdIYKe
# Gd8ONpuoPIY84p+URezkb3LHRTPJm23nuFhtVAnAaiGIVlSiAid4cRNE5Jo0sYZK
# IVTTzBzayByUz3JVEvpWbZnxqdWBRDfGMBQYxZBxX/jICSqF1/+3zlxc4cBy8Do9
# xUbkgesUCO2XS2QJBK8yGdJsP9zsTWdi9Kngo7nBmA08OZUCwL0Dv/7vR8humate
# tSkAZvK4
