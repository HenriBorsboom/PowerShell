...
function Get-DocumentContent([String] $SourceId, [String] $Scenario, [String] $Version, [String] $Setting, [String] $Action) {
    Invoke-ScriptBlock -ScriptBlock {
        Write-Verbose "[$SourceId] Getting document content(s)."
        $Documents = Get-OsConfigurationDocument -SourceId $SourceId | Get-OsConfigurationDocumentContent | ConvertFrom-Json | ForEach-Object { ConvertTo-Document -Document $_ }
...
function Get-DocumentResult([String] $SourceId, [String] $Scenario, [String] $Version, [String] $Setting, [String] $Action) {
    Invoke-ScriptBlock -ScriptBlock {
        ...
        $Documents = Get-OsConfigurationDocument -SourceId $SourceId | Get-OsConfigurationDocumentResult | ConvertFrom-Json | ForEach-Object { ConvertTo-DocumentResult -Document $_ }

        if (Get-Capability -Capability DocumentResultVersion) {
            $Documents | Select-Document -Scenario $Scenario -Version $Version -Setting $Setting -Action $Action
        } else {
            # Filter out documents with a workaround due to platform bug (incorrect schema version).
            if ($Version) {
                $Documents = $Documents | Where-Object {
                    $Document = Get-OsConfigurationDocumentContent -SourceId $SourceId -Id $_.OsConfiguration.Document.Id | ConvertFrom-Json | ForEach-Object { ConvertTo-Document -Document $_ }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC6HUqfF9T7XN7B
# Emzow/Pzolv1HZB6VKDxhnT1ERwyBqCCDXYwggX0MIID3KADAgECAhMzAAADrzBA
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIKf4uCr/5rDil27E8r3RIgiR
# X3tqbVLKpUgoT1LDoX1EMEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEB
# BQAEggEAgIQtgy4efoQ7tr/7afv06asArmJUC1Il60wvQ17I4HDnL0L17B6Wkkeq
# Lp/JG+1FHnLHKHhPIVZlzdNvqgpvuslH/PFIjlnWmtEtYuialhJzcIu2YuZ+V5UZ
# C+eeczA+RYqTw5mpOp8mg8QvcoPDaANhD7Ews8n8qTuE+XYzpCQImx7Hv1jNC92b
# HkMMMWZdqDKqJcyLQ/i58CL9T0n5jKqHJwCnf89Ge3odCJcAQHdiAuqzJDIyOShA
# ifNvbSJYP4sdTOQmQ1jClx9rQ/xk7R4na79uA2tXzDPZOlMStCsTcZovzTIAEUEP
# vQwKCgGNbuUhZu6JBJejflndNU/VnKGCFyowghcmBgorBgEEAYI3AwMBMYIXFjCC
# FxIGCSqGSIb3DQEHAqCCFwMwghb/AgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFZBgsq
# hkiG9w0BCRABBKCCAUgEggFEMIIBQAIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFl
# AwQCAQUABCARMZ+xvx+td5nHbzjdC3I/q+gjfqNK81kQuVlxm96PjAIGZdY1qYbK
# GBMyMDI0MDMxMjE5MDE1Ni41NzZaMASAAgH0oIHYpIHVMIHSMQswCQYDVQQGEwJV
...
# MSIEIMFjucp966ERwfug50rbhTSOYjwr5GTXbz9tYow3zyOeMIH6BgsqhkiG9w0B
...
# CzANBgkqhkiG9w0BAQsFAASCAgAp2SvhRNpUBno3P3KdZ0oQ7XDSsW6FML/+Ni73
# d5W2oEuU2fn0H4SlxFqzCoJ28bvo8DxL4Kmj34kzLSiTN7Ovxp/tTrjCYpLHxOVC
# DioDEdpDQEisw3xvc0iZCaMz1TqB03ZrurssEXExWQdVSRQK0A4AxtFFmZq0CtHj
# si2u7RxsX1v4eyokYiFeC39gD0M3zc4ZEmIXf12ad1hhNF93Pf5AW6ovQbPsBrQH
# VNvTADIxj9XyNVwyWpdZs+BO2QukAKdjcj4e6BXuKpwDVlxSXb/61zd0Wf9ZQGdU
# 0IkHPzYd2E4bZs21Q7GDYOuiVBDOQCGeIm786ak32fLICi/SAiAi64iswwqRBpav
# gase7Jaa0mMSV0bcwCMZqx5T5ehN8SpJYLb0m2RLuwTCEAxKt3a+m6bNqPf7AzzD
# qEyFT3vODOwDfYOMtBbkSgrpqJwoSswtcxuEs/5IBPvQg966DBnqqvboFi5O/bEU
# klJCRmeMAmP2aoHSyRdtmlD0I3UqM4dwm0j3dLlyBylfg3EtO855Aljjeeo+zUTt
# I/lANnr9rxBnES23p2BZ/4PJEAGkvtDFqKRwKed/efV59nDn0m8B2ijcdwDjEjQ4
# QOahWPDRE0+yZDqzSm6ZowDl4uyqg/O6RkK+TXVvBF61YJ7x1pw9CA4ifcwA+zHb
# 5QqrJw==
