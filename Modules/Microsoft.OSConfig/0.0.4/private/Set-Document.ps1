...
function Set-Document([String] $SourceId, [PSCustomObject] $Document) {
    ...
    Invoke-ScriptBlock -ScriptBlock {
        ...
        Set-OsConfigurationDocument -SourceId $SourceId -Content $Content -Wait -TimeoutInSeconds 300
    }

    # Check if all settings were applied successfully.
    if ($Document.OsConfiguration.Scenario[0].Action -eq "Set") {
        $Document = Get-OsConfigurationDocumentResult -SourceId $SourceId -Id $Document.OsConfiguration.Document.Id | ConvertFrom-Json | ForEach-Object { ConvertTo-DocumentResult -Document $_ }

        if ($Document.OsConfiguration.Document.Status.State -eq "Failed") {
            $FailedSettings = $Document.OsConfiguration.Scenario[0].Status | Where-Object { $_.State -eq "Failed" }

            if ($FailedSettings) {
                $ErrorMessage = ($FailedSettings | ForEach-Object { $Strings.ErrorInvalidSetting -f $_.Name, $_.ErrorCode }) -join " "
            } else {
                $ErrorMessage = $Strings.ErrorInvalidSettings
            }

            throw [InvalidValueException]::new($ErrorMessage)
        }
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBp5Y1IWNeyA12+
# ghpRZiARX2o5JrgMzFdjCez64vYf+KCCDXYwggX0MIID3KADAgECAhMzAAADrzBA
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIN/1rhG22pbk2DUMyy7iPFwQ
# j2SDT2UuPBmqffA63qPEMEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEB
# BQAEggEAijzLd4bJjBvYbJSy0lp9tygk3JyEPwCCCKEB/Lvtg7IiFRfZ1fzfjZam
# RiqzjHcSX6gamfVSKjuJUA9E6lmyIWxplZi48tKQqenZ+hwsOD6UFgd5CjNC7rm5
# sB4/qBMMLXNiFOuaEOnotF2aP5qr2sqMST5uA0U0znOEKCABGsxTOFaunlVS3Ybx
# BwjuMoqbjmPRsJBrpgvAH7g7B4/EH4dccWlwL/+vznlpCtEqsqaD5ss21VcNiTi8
# 21r6Zg/YrnDW8Fqr+oCd2ethsB5Nsp2JcBN/7UwfBQK7ebJx7/GXy9EbTGlHekx6
# yhcAvmmA7Pf4tn5qqOVuNx5jPrW9IaGCF5YwgheSBgorBgEEAYI3AwMBMYIXgjCC
# F34GCSqGSIb3DQEHAqCCF28wghdrAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFRBgsq
# hkiG9w0BCRABBKCCAUAEggE8MIIBOAIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFl
# AwQCAQUABCC6TRluygBC/+csgf+Q44+q6UIehq1zqltDF28vztk1DQIGZeeoNL5n
# GBIyMDI0MDMxMjE5MDE1My40MlowBIACAfSggdGkgc4wgcsxCzAJBgNVBAYTAlVT
...
# UENBIDIwMTAwDQYJKoZIhvcNAQELBQACBQDpmrf+MCIYDzIwMjQwMzEyMTExNjE0
# WhgPMjAyNDAzMTMxMTE2MTRaMHcwPQYKKwYBBAGEWQoEATEvMC0wCgIFAOmat/4C
# AQAwCgIBAAICFv8CAf8wBwIBAAICD5MwCgIFAOmcCX4CAQAwNgYKKwYBBAGEWQoE
# AjEoMCYwDAYKKwYBBAGEWQoDAqAKMAgCAQACAwehIKEKMAgCAQACAwGGoDANBg