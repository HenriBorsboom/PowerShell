...
$Transformers = @{
    "Policy" = "ConvertTo-Policy"
}

function Invoke-Transformer([Object] $Schema, [PSCustomObject] $Value) {
    if ($null -eq $Value) {
        return $Value
    }

    if (-not ($Schema.DataType -eq "Scenario")) {
        $Transformer = $Schema.Transformer

        if ($Transformer -and $Transformers.ContainsKey($Transformer)) {
            $Command = $Transformers[$Transformer]
        ...
        # Iterate over the keys of the scenario's value and transform each setting individually.
        $Settings = $Value.PSObject.Properties
        $Settings | ForEach-Object {
            $SettingName = $_.Name
            $SettingValue = $_.Value
            $SettingSchema = $Schema.Settings | Where-Object { $_.Name -eq $SettingName }
            $Value.$SettingName = Invoke-Transformer -Schema $SettingSchema -Value $SettingValue
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCABV+TkZX5Y2h7P
# El24gzx1DsKYn2wS+ZFmBOm1UEn98qCCDXYwggX0MIID3KADAgECAhMzAAADrzBA
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIOkm22r3oPRnWxjPmLG9bKBu
# HeXbaCZw+eSh2Xmt85SBMEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEB
# BQAEggEAA8/m1MDmqqt9Ue7r335EBFgRLPXKqdm1+Miko5nthNQqFD432oXwjIkG
# ya6Vbq14LUbdzjfd2OGGfqNQV1YITuD7BqtHIj1eN877n11WIJu+ErOOujBjVmHr
# MJYT0NIFZ4qLwkVLsAVlrRsIT1PsYAryBkIY8xYqsCRBYLtq2NbJwJulFWdbyXQt
# E2J2CmEjgdJFR3ug/T+p+9cjV3ZmPPLC+bm89fvnFRozi3/RrW0hYF6kEMd9SpCS
# s7pBgNPC6jJzTWk0bm2E7yfpTP9+LyFAMlvjFZ3ZQYIQZ1J0PPGPoGGK1n8L2vxs
# Arj7WgfNUfkxo40uTizpkzGXSLrmHaGCFyowghcmBgorBgEEAYI3AwMBMYIXFjCC
# FxIGCSqGSIb3DQEHAqCCFwMwghb/AgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFZBgsq
# hkiG9w0BCRABBKCCAUgEggFEMIIBQAIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFl
# AwQCAQUABCCLQUfIjrrNITBYnB2ljyVkw46IcLASKXtInJEUINxSeAIGZdY1qYeG
# GBMyMDI0MDMxMjE5MDE1OS4wNzlaMASAAgH0oIHYpIHVMIHSMQswCQYDVQQGEwJV
...
# MSIEIFdQUl2qRy11DuRe3OGk5PCiSwKdHWW3IwcvqQgcjhN5MIH6BgsqhkiG9w0B
...
# CzANBgkqhkiG9w0BAQsFAASCAgA0Mafw8jy4UjWdMNQevVZQT8Z0AlewIxVgHmGB
# yXXo+/OuJxWy6Abem4CgTJHHCzYQcZk0hnRVRcCbzZKxyGTQgOpFyeqmmoc1MP/Z
# QF8p/aMMXZmxfrNqMiyWlhFk7f79uCCu0CY2qaVGSxA6jIGOBRlZBFZxHK3Gfivt
# vL7ArKat1rh2ShdeYITfYfC4eESVcjcPDNaiusmYW2AKyOVoquK3LLTT8YCjnHFK
# UKOuGhXtbjTIzGJnk6kqXeNWbOjMIDkob7NBmpKLZU6bqC2KdXiQsSM/gQUywPUY
# t/FcmLDwpTGy3RnJ4SRo46Q2qFMzV8oaRNqxh462rVWrZqo8eFtFt7osLphZqfDP
# ZLmFaeAJsBDhqjAqRd+IEy9uUf7L88BUq0Ik8CRzo2PpoF390bThFOZdnUml92/7
# fkYFE27Qat/l70dXwEcmpaQDLdEsdmhkM8sZbn1QJt+p9a1CIc591uTgs3G2OOft
# /Qo8N+Do0bjgDL0aSOyUZYFQX4QExPDIXX4Y/HILhBgEPiQOQ1QLpNot1n1kMqWA
# 7BWrraO9QwZrxLUcFvjjaKhT353k3kTJEACsWuCJzp5pwyFytTyvHyNx96QA6409
# CoUMR7uKl8/gBdM2XC0y42URFjMavo/mzoNGbAC5SGFRiAXEDEmt7DhDmADRqRSI
# 8C6HRA==
