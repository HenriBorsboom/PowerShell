...
Side notes
Updated Global Variable $To from [String] to [String[]]
Updated Get-VMSrunning to keep the health icon from previous host
...
Param (
    ...
    [String] $Password)
[String] $Global:ScriptVersion = '3.5.2'
#region Variables
# Alarms
...
# VMs
$VMCriticalExclusionList  = @()                                  # This is to tag VMs with special names as Warning instead of Critical
$VMCriticalExclusionList += '*do not power*'
$VMCriticalExclusionList += '*_clone*'
$VMCriticalExclusionList += '*leave offline*'
$VMCriticalExclusionList += '*do not delete*'
$VMCriticalExclusionList += '*or power on*'
$VMCriticalExclusionList += '*template*'
$VMCriticalExclusionList += '*not power on*'
# VM Snapshots
...
[string[]] $To            = @('henri.borsboom@eoh.com', 'ian.vanderwesthuizen@eoh.com')
...
If ($IPAddress -eq '') {
    $ReportingEnvironment = New-Object -TypeName PSObject -Property @{
        'System Name' = 'KAPJHBCLUS01';
        'IP Address'  = '172.30.2.29';
        'Common Name' = 'KAP - Johannesburg';
        'Platform'    = 'HyperVCluster'; # Valid Options are HyperVCluster, HyperVStandalone, VMWare, Dummy
        'Username'    = '';
        'Password'    = '';
    }
}
