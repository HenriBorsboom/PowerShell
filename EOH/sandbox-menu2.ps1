#MenuColors
$SeperatorColor          = [ConsoleColor]::Green
$MenuItemIndexBlockColor = [ConsoleColor]::DarkCyan
$MenuItemIndexColor      = [ConsoleColor]::DarkCyan
$MenuItemTextColor       = [ConsoleColor]::White
$StartLineColor          = [ConsoleColor]::Green
$MenuTitleColor          = [ConsoleColor]::Cyan
$EndLineColor            = [ConsoleColor]::Green
    ...
    Switch ($Action) {
        ...
        "Write"  {
            Switch ($Type) {
                ...
                "MenuTitle" {
                    Write-Color -Text $StartLine, $MenuTitle, $EndLine -ForegroundColor $StartLineColor, $MenuTitleColor, $EndLineColor
                }
            }
        }
    }
