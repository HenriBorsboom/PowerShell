...
'###################################################
	...
	emailSubject = "AMT Active Directory Health Summary"
	emailFrom = "eohrt_vm_storage@eoh.com"
	emailTo = "amanzi.matora@eoh.com"
	emailCc = "" 
	emailPort = 25
	emailAuth = 1	
	emailSenderUser = "eohrt_vm_storage@eoh.com"
	emailSenderPassword = "v3Rystr0nGP@ssword2019"
	emailServer = "za-smtp-outbound-1.mimecast.co.za"
	emailSSL = False
