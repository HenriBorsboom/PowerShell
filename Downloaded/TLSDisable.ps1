New-Item 'HKLM:\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Protocols\TLS 1.1\Server' -Force | Out-Null
    ...
    Write-Host 'TLS 1.1 has been Disabled.' -BackgroundColor Green
...
New-Item 'HKLM:\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Protocols\TLS 1.2\Server' -Force | Out-Null
    ...
    Write-Host 'TLS 1.2 has been Disabled.' -BackgroundColor Green
    
  $service = Restart-Service -Name 'Site24x7 Windows Agent' -force

  if ($service) {
   Write-Host "Service STARTED/RESTARTED" -BackgroundColor Green
  }
  else {
   Write-Host "Service UNABLE to Restart" -BackgroundColor Red
  }
