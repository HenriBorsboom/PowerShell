...
Function Set_IPs
{
    Param(
        ...
        [string]$Set)
    If ($Set = "1")
    {        Enable_DHCP "1"        netsh interface ipv4 set address "2166 - VM" static 10.10.16.240 255.255.255.128 10.10.16.129
        netsh interface ipv4 set address "2167 - CSV" static 10.10.145.21 255.255.255.192 10.10.145.1        netsh interface ipv4 set address "2168 - HB" static 10.10.145.81 255.255.255.192 10.10.145.65        netsh interface ipv4 set address "2169 - MGMT" static 10.10.231.231 255.255.255.192 10.10.231.193
        netsh interface ipv4 set address "2170 - Ten 1" static 10.10.29.2 255.255.255.240 10.10.29.1
        netsh interface ipv4 set address "2171 - Ten 2" static 10.10.29.18 255.255.255.240 10.10.29.17
        netsh interface ipv4 set address "2172 - Ten 3" static 10.10.29.34 255.255.255.240 10.10.29.33        netsh interface ipv4 set address "2173 - Ten 4" static 10.10.29.50 255.255.255.240 10.10.29.49
    }
    Elseif ($Set = "2")
    {
        Enable_DHCP "2"
        netsh interface ipv4 set address "2174 - Ten 5" static 10.10.29.66 255.255.255.240 10.10.29.65
        netsh interface ipv4 set address "2175 - Ten 6" static 10.10.29.82 255.255.255.240 10.10.29.81
        Netsh interface ipv4 set address "2176 - Ten 7" static 10.10.29.98 255.255.255.240 10.10.29.97
        netsh interface ipv4 set address "2177 - Ten 8" static 10.10.29.114 255.255.255.240 10.10.29.113
        netsh interface ipv4 set address "2178 - Ten 9" static 10.10.29.130 255.255.255.224 10.10.29.129
        netsh interface ipv4 set address "2179 - Ten 10" static 10.10.29.162 255.255.255.224 10.10.29.161
        netsh interface ipv4 set address "2180 - Ten 11" static 10.10.29.194 255.255.255.224 10.10.29.193
        netsh interface ipv4 set address "2181 - Ten 12" static 10.10.29.226 255.255.255.224 10.10.29.225
    }
}
