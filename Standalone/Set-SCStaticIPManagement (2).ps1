...
Set-SCStaticIP -SCVM $SCVM -SCVirtualSwitch "ConvergedHyperSwitch" -IPPoolName "Windows Azure Pack Services" -VMNetwork $VMNetwork -VLANID 2168 -NetworkAdapterNumber 0 -IP $IP
#.\Set-SCStaticIP.ps1 -SCVM $SCVM -SCVirtualSwitch "ConvergedHyperSwitch" -IPPoolName "Windows Azure Pack Services" -VMNetwork $VMNetwork -VLANID 2168 -NetworkAdapterNumber 0 -IP $IP
