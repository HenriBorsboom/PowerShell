...
Function Create-Networks {    
    ...
    $CSVIP = "10.10.145." + $ManIPLastOctet
    $HtBIP = "10.10.29." + $ManIPLastOctet
    #Create new NIC team using two existing physical adapters in host, set LB and teaming mode
    New-NetLbfoTeam -Name NICTeam01 -TeamMembers pNIC1,pNIC2 -LoadBalancingAlgorithm TransportPorts -TeamingMode SwitchIndependent
    ...
    New-NetIPAddress -InterfaceAlias "vEthernet (HB)" -IPAddress $HtBIP -PrefixLength "26"
}
