<#
    ...
    .Link
        https://www.linkedin.com/pulse/powershell-simplifying-handling-multiple-start-job-henri-borsboom
...
#Example of Use
Clear-Host
[System.Management.Automation.ScriptBlock] $SB1 = [System.Management.Automation.ScriptBlock] (Get-Content .\test.ps1 )
$SBArgs = @(1)
Start-Jobs -ScriptBlock $SB1 -Targets @(1..30) -PassTargetToScriptBlock TargetOnly -ReportImmediate