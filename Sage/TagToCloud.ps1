$VM = Get-SCVirtualMachine -Name "NRAZBCK102" #| where Name -like "VIP-*"
...
#$VM = Get-SCVirtualMachine -Name "VIP-AXIOMATIC"
    ...
    Write-Host " - " -NoNewline
        $Empty = Set-SCVirtualMachine -VM $VM -Name "VIP-CLOUD-PDC" -Description "" -Cloud $Cloud -ErrorAction Stop
