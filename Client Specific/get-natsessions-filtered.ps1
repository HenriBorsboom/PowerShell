Function All-NATSessions {
    ...
    $AllNATSessions = $AllNATSessions | Sort InternalSourceAddress | Select Protocol, InternalSourceAddress, InternalSourcePort, InternalDestinationAddress, InternalDestinationPort, ExternalSourceAddress, ExternalSourcePort, ExternalDestinationAddress, ExternalDestinationPort
...
Function TCP-NATSessions {
    ...
    ForEach ($NATSession in $NATSessions) {
        ...
        If ($NATSessionProtocol -eq 6) {
            ...
            $TCPNATSession = $TCPNATSession | Select `
                CreationTime, `
                Protocol, `
    ...
    $AllTCPSessions = $AllTCPSessions | Sort InternalSourceAddress | Select `
                CreationTime, `
                Protocol, `
                InternalSourceAddress, `
                InternalSourcePort, `
...
Function UDP-NATSessions {
    ...
    $AllUDPSessions = $AllUDPSessions | sort InternalSourcePort | select `
            CreationTime, `
            Protocol, `
            InternalSourceAddress, `
            InternalSourcePort, `
